...
class OrderControllerTest {
    ...
    void delete() throws Exception {
        ...
        ShoppingItem testShoppingItem = testData.createShoppingItem(1L, "Test", BigDecimal.valueOf(2.0));
    ...
    void placeOrderTest() throws Exception {
        ...
        Order order = testData.creatOrder(1L, buyer,List.of(shoppingBasket), false);
        buyer.setOrders(List.of(order));
